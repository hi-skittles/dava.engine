...
public:
    ...
    {
        return const_cast<T*>(const_cast<const FCDLibrary*>(this)->FindDaeId(daeId));
    }
    ...
    inline T* GetEntity(size_t index)
    {
        FUAssert(index < GetEntityCount(), return NULL);
        return entities.at(index);
    }
    inline const T* GetEntity(size_t index) const
    {
        FUAssert(index < GetEntityCount(), return NULL);
        return entities.at(index);
    } /**< See above. */
